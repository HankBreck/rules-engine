...
with open("examples/zen-gtorlt.json") as f:
    content = f.read()
zen_rules = [(zen_engine.create_decision(content), big_dict)]
...
rust_runtime = timeit.timeit(test_rust_rule_engine, number=10_000)
print("Starting Zen profile")
zen_runtime = timeit.timeit(test_zen_rule_engine, number=10_000)
print("Starting Python profile")
py_runtime = timeit.timeit(test_py_rule_engine, number=10_000)
print("Starting eval profile")
eval_runtime = timeit.timeit(test_eval, number=10_000)
print()
